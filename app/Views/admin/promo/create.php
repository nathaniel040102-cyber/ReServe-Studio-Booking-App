<div class="container mt-4">
    ...
    <h2 class="mb-4">Tambah Promo Baru</h2>
    ...
    <div class="card shadow-lg p-4">
        <form action="<?= base_url('admin/promos/store') ?>" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" id="kode_promo" name="kode_promo" class="form-control" value="<?= old('kode_promo') ?>" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" id="nilai_diskon" name="nilai_diskon" class="form-control" value="<?= old('nilai_diskon') ?>" step="any" required min="0">
            </div>
            <div class="mb-3">
                <label for="tanggal_mulai" class="form-label">Tanggal Mulai (YYYY-MM-DD HH:MM):</label>
                <input type="datetime-local" id="tanggal_mulai" name="tanggal_mulai" class="form-control" value="<?= old('tanggal_mulai', date('Y-m-d\TH:i')) ?>" required>
            </div>
            <div class="mb-3">
                <label for="tanggal_berakhir" class="form-label">Tanggal Berakhir (YYYY-MM-DD HH:MM):</label>
                <input type="datetime-local" id="tanggal_berakhir" name="tanggal_berakhir" class="form-control" value="<?= old('tanggal_berakhir', date('Y-m-d\TH:i', strtotime('+1 month'))) ?>" required>
            </div>
            <div class="mb-3">
